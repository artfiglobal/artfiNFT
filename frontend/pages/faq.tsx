      ...
      <>
        <div style={{ display: "flex", margin: "34.5px 0" }}>
          <ListItemText
            ...
            primary={
              <>
                <span className={stylesFaq.question}>{question.question}</span>
              </>
            }
          />
          {open ? (
        ...
        <Collapse in={open} sx={{ padding: "0" }} timeout="auto" unmountOnExit>
          <List
            component="div"
          ...
          >
            <ListItemText sx={{ color: "#585858" }}>
              <span className={stylesFaq.answer}>{question.answer}</span>
            </ListItemText>
          </List>
        </Collapse>
        <Divider />
