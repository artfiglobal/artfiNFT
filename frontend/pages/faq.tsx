...
const Faq = (props: Props) => {
    ...
    const [open, setOpen] = React.useState(false);
        ...
        <ListItemText onClick={()=>setOpen(!open)} primary={<><span className={stylesFaq.question}>{question.question}</span></>} />
                ...
                >
                    {props.data.map((question:any, index: any) => {
                        ...
                        return (<>
                            ...
                            {question.section == "section1"?<CollapseData question={question} index={index}/>:""}
                ...
                >
                    {props.data.map((question:any, index: any) => {
                        ...
                        return (<>
                            ...
                            {question.section === "section2"?<CollapseData question={question} index={index}/>:""}
                            <Divider />
                        </>)
                    })}
