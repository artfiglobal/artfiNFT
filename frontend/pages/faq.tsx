...
const questionsList2: Array<questions> = [
  {
    question:
      "Which Web3 wallets are supported for the Artfi NFT public mint?  ",
  ...
  {
    question:
      "Which network must I set my wallet to for the Artfi NFT public mint? ",
  ...
  {
    question:
      "I have never used cryptocurrency before. How do I purchase an Artfi NFT? ",
  ...
  {
    question:
      "How many Artfi NFTs can I reserve during the whitelist process?     ",
  ...
  {
    question:
      "I am having a technical problem trying to mint an Artfi NFT. Can I receive technical support?",
  ...
  {
    question:
      "I Whitelisted for Artfi NFTs but I no longer want to purchase them. Is that OK?",
              ...
              <>
                <div style={{ display: "flex", margin: "34.5px 0" }}>
                  <ListItemText
                    ...
                    primary={
                      <>
                        <span className={stylesFaq.question}>
                          {question.question}
                        </span>
                      </>
                    }
                ...
                >
                  <List
                    component="div"
                    sx={{ marginBottom: "38px", marginTop: "-29px" }}
                    disablePadding
                  >
                    <ListItemText sx={{ color: "#585858" }}>
                      <span className={stylesFaq.answer}>
                        {question.answer}

                        {index == 7
                          ? " If you are an art collector or artist in possession of an artwork that you would like to sell through the Artfi consignment process, please contact management at consignment@artfi.world. "
                          : ""}

                        {index == 4
                          ? "Regardless of the secondary market price of an Artfi NFT, it will always be redeemable for the  proceeds from the future sale of the physical artwork to which the Artfi NFT corresponds."
                          : ""}

                        {index == 2
                          ? "For example, if a painting that was fractionalized into 10,000 NFTs is sold by Artfi for $5 million (after commission), and you hold two of the NFTs which correspond to this painting, you will have the option to redeem your NFTs for $1,000 worth of stablecoin or ARTFI token."
                          : ""}
                        {index == 6 ? (
                          <a
                            style={{ color: "blue" }}
                            href="https://www.artfi.world/how-it-works"
                          >
                            <u>https://www.artfi.world/how-it-works</u>
                          </a>
                        ) : (
                          ""
                        )}
            ...
            return (
              <>
                <div style={{ display: "flex", margin: "34.5px 0" }}>
                  ...
                  />
                  {question.open ? (
                    <ExpandLess onClick={() => handleClick2(index)} />
                  ) : (
                    <ExpandMore onClick={() => handleClick2(index)} />
                  )}
                </div>
