...
const leftNavMapping = [
  {
    ...
    title: (
      <>
        <label style={{ opacity: "0.8" }}>Company</label>
      </>
    ),
  },
  {
...
export const Footer = ({ display }: FooterProps): JSX.Element => {
  ...
  const socialMapping = [
    {
      ...
      icon: (
        <div className={styles.tooltip}>
          <img src="Icons/icon-Discord.svg" />
          <span className={styles.tooltiptext}>Discord</span>
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className={styles.tooltip}>
          <img src="Icons/facebook-svgrepo-com 1.svg" />
    ...
    },
    {
      ...
      icon: (
        <div className={styles.tooltip}>
          <img src="Icons/icon-Discord-1.svg" />
    ...
    },
    {
      ...
      icon: (
        <div className={styles.tooltip}>
          <img src="Icons/icon-twitter-1.svg" />
          <span className={styles.tooltiptext}>Announcement</span>
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className={styles.tooltip}>
          <img src="Icons/icon-twitter-1.svg" />
          <span className={styles.tooltiptext}>Chat</span>
        </div>
      ),
    },
  ...
  return (
    <>
      ...
      <div
        className={styles.outerFooter}
        style={{ background: "white", display: display }}
      >
        <img
          src="/Publiced/Powered by.svg"
          alt="Powerd By"
                ...
                return (
                  <div key={index}>
                    <Link href={data.link} key={index} passHref>
                      {data.link ===
                      "https://977vnkbygg7.typeform.com/to/SevVnwe8" ? (
                ...
                return (
                  <>
                    <Link href={data.link} key={index} passHref>
                      ...
                      data.title === "Careers We re Hiring" ? (
                        <a target="_blank"> {data.title} </a>
                      ) : (
                        data.title
                      )}
            ...
            >
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  ...
                  <button onClick={() => setSendEmail(false)}>Okay</button>
                </DialogContentText>
              </DialogContent>
            </Dialog>
          </div>
